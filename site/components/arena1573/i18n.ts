...
const english: Record<string, string> = {
  ...
  '活动人群': 'Event crowd', '园区行人 · 看台观众': 'Walking visitors & seated fans',
  ...
  '日落与夜场为艺术灯光预设，网球轨迹为演示动画。观众和街道家具是示意布置。': 'Sunset and night are artistic lighting presets; the ball follows a demonstration animation. Spectators and street furniture are illustrative.',
...
const chinese: Record<string, string> = {
  ...
  'A little match-day life': '园区行人 · 入场与离场 · 看台观众', 'SPACE': '空格', 'FIELD NOTES': '场馆笔记', 'EXPLORE': '探索',
